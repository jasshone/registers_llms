...
OUT_DIR = BASE_DIR / "regenerated_figures"
...
SOURCES = {
    "figure2": Path(
        "artifacts/realtext_toy_shifted_bos_gradients/"
        "wikitext103_train_expanded_3seed/aggregate_gradient_summary.csv"
    ),
    "figure2_cached_reference": Path(
        "artifacts/realtext_toy_bos_train_position/"
        "wikitext_pythia_cached_val_windows/bos_train_position_summary.csv"
    ),
    "figure3": Path(
        "artifacts/realtext_toy_bos_presence_controls/"
        "wikitext103_train_3seed/aggregate_summary.csv"
    ),
    "figure7": Path(
        "artifacts/toy_pretrained_bridge/"
        "wikitext_pythia_tokenizer_10k_scale10_test512/"
        "toy_relocation_bridge_metrics.csv"
    ),
    "figure8": Path(
        "artifacts/sink_hijacking_attack/repeated_bos_prefix/"
        "pythia_1b_full/repeated_bos_prefix_metrics.csv"
    ),
    "figure9_wikitext": Path("artifacts/final_split_bias_transfer_source_abs_bonus0/final_results.csv"),
    "figure9_pile": Path("artifacts/pile_val_sharded_transfer_full/summary_shards.csv"),
    "figure9_mmlu": Path("artifacts/mmlu_transfer_eval_full_test/summary.csv"),
}
