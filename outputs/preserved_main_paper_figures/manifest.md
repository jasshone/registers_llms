...
## Source CSVs
- figure2: `outputs/realtext_toy_bos_train_position/wikitext_pythia_cached_val_windows/bos_train_position_summary.csv`
...
- figure9_pile: `outputs/pile_val_sharded_transfer_full/summary_shards.csv`
- figure9_mmlu: `outputs/mmlu_transfer_eval_full_test/summary.csv`
