...
- Figure 3 rendered in the urgent set now uses `realtext_toy_shifted_bos_gradients/wikitext103_train_expanded_3seed/aggregate_gradient_summary.csv`, which has 3 seeds for single_0, no_bos, single_8, single_32, duplicate_0,8, and duplicate_0,32. The older uneven-seed presence-control aggregate remains preserved under `artifacts/realtext_toy_bos_presence_controls/wikitext103_train_3seed`.
